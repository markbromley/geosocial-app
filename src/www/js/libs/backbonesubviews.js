 ...
 * Copyright (c)2016 Rotunda Software, LLC.
    ...
    Backbone.Subviews.add = function( view ) {
        ...
        function _postrender() {
            ...
            this.$( "div[data-subview]" ).each( function() {
                ...
                //below modified by Marky Mark replaceWith() changed to empty().append()
                thisPlaceHolderDiv.empty().append( newSubview.$el );                
            } );
